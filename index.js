(()=>{
    ...
    *******************************/
    ...
    const btnMenuContainer = document.getElementById("btn-menu-container");
    const btnClose = document.getElementById("btn-close");
    const btnSearch = document.getElementById("btn-search");
    const inputSearch = document.getElementById("input-search");
    const searchContent = document.getElementById("search-content");
    const logoBox = document.getElementById("logo-box");
    const circleMask = document.getElementsByClassName("circle-mask");
    ...
    *******************************/
    ...
    searchContent.addEventListener("click", SearchHandler);
    window.addEventListener("resize", ()=> LogoResponsiveManager());
  ...
  */
    ...
    function LogoResponsiveManager(){
            ...
            <svg class="logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                ...
                <g id="Layer_2" data-name="Layer 2">
                    <g id="Layer_1-2" data-name="Layer 1">
                        <path class="logo-color" d="M65.68,16.68H40.37A28,28,0,0,0,12.49,41.61h0A28.06,28.06,0,0,1,37,0H80.73Z"/>
                        <path class="logo-color" d="M15.05,72.78H40.37A28.06,28.06,0,0,0,68.25,47.85h0a28,28,0,0,1-24.56,41.6H0Z"/>
                        <circle class="logo-color" cx="40.37" cy="44.73" r="22.53"/>
                    </g>
                </g>
            </svg>
            `;

            circleMask.innerHTML = ``;
        }
        else {
            logoBox.innerHTML =  `
                ...
                <svg class="logo" 
                    ...
                    <g id="surface1">
                        ...
                        <path class="logo-color" style=" stroke:none;fill-rule:nonzero;fill:rgb(92.54902%,6.666667%,10.196078%);fill-opacity:1;" d="M 36.832031 21.703125 C 35.296875 23.617188 32.503906 23.925781 30.589844 22.394531 C 28.675781 20.859375 28.363281 18.0625 29.894531 16.148438 C 31.429688 14.230469 34.222656 13.921875 36.136719 15.453125 C 36.390625 15.65625 36.625 15.886719 36.832031 16.136719 L 40.8125 12.140625 C 38.910156 10.039062 36.203125 8.84375 33.367188 8.847656 C 27.816406 8.828125 23.027344 12.792969 23.027344 18.910156 C 23.027344 25.023438 27.867188 29 33.417969 29 C 36.257812 29 38.964844 27.800781 40.875 25.699219 Z M 36.832031 21.703125 "/>
                        <path class="logo-color" style=" stroke:none;fill-rule:nonzero;fill:rgb(92.54902%,6.666667%,10.196078%);fill-opacity:1;" d="M 106.402344 28.542969 L 106.402344 9.304688 L 100.535156 9.304688 L 100.535156 11.34375 L 99.984375 10.867188 C 98.617188 9.554688 96.789062 8.820312 94.894531 8.828125 C 89.707031 8.828125 85.328125 13.445312 85.328125 18.910156 C 85.328125 24.371094 89.71875 29 94.894531 29 C 96.789062 29.003906 98.617188 28.273438 99.984375 26.960938 L 100.535156 26.480469 L 100.535156 28.519531 Z M 95.871094 23.445312 C 93.363281 23.429688 91.34375 21.382812 91.359375 18.875 C 91.371094 16.367188 93.410156 14.34375 95.917969 14.351562 C 98.425781 14.363281 100.449219 16.402344 100.445312 18.910156 C 100.441406 20.117188 99.957031 21.277344 99.097656 22.128906 C 98.242188 22.980469 97.078125 23.453125 95.871094 23.445312 Z M 95.871094 23.445312 "/>
                        <path class="logo-color" style=" stroke:none;fill-rule:nonzero;fill:rgb(92.54902%,6.666667%,10.196078%);fill-opacity:1;" d="M 153.71875 28.542969 L 153.71875 9.304688 L 147.851562 9.304688 L 147.851562 11.34375 L 147.300781 10.867188 C 145.929688 9.554688 144.105469 8.824219 142.207031 8.828125 C 137.023438 8.828125 132.644531 13.445312 132.644531 18.910156 C 132.644531 24.371094 137.035156 29 142.207031 29 C 144.105469 29.003906 145.929688 28.273438 147.300781 26.960938 L 147.851562 26.480469 L 147.851562 28.519531 Z M 143.226562 23.445312 C 140.714844 23.449219 138.675781 21.417969 138.671875 18.90625 C 138.667969 16.394531 140.703125 14.355469 143.214844 14.351562 C 145.722656 14.351562 147.757812 16.386719 147.757812 18.898438 C 147.757812 21.40625 145.730469 23.4375 143.226562 23.445312 Z M 143.226562 23.445312 "/>
                        <path class="logo-color" style=" stroke:none;fill-rule:nonzero;fill:rgb(92.54902%,6.666667%,10.196078%);fill-opacity:1;" d="M 115.398438 28.542969 L 115.398438 26.503906 L 115.9375 26.980469 C 117.308594 28.292969 119.132812 29.023438 121.03125 29.019531 C 126.214844 29.019531 130.59375 24.402344 130.59375 18.929688 C 130.59375 13.457031 126.214844 8.847656 121.03125 8.847656 C 119.132812 8.84375 117.308594 9.574219 115.9375 10.886719 L 115.398438 11.367188 L 115.398438 0.480469 L 109.519531 0.480469 L 109.519531 28.542969 Z M 115.519531 18.929688 C 115.507812 17.085938 116.605469 15.421875 118.304688 14.707031 C 120 13.992188 121.957031 14.375 123.265625 15.671875 C 124.570312 16.96875 124.964844 18.929688 124.261719 20.632812 C 123.5625 22.332031 121.902344 23.445312 120.0625 23.445312 C 117.558594 23.445312 115.527344 21.414062 115.519531 18.910156 Z M 115.519531 18.929688 "/>
                    </g>
                </svg>
            `;

           
            for(var item of circleMask){
                item.innerHTML = `
                <svg class="circle-mask-content" viewBox="0 0 500 150" preserveAspectRatio="none" style="height: 100%; width: 100%;">
                    <path class="mask" style="stroke: none; fill: red;" d="M68.85,-10.34 C1.70,34.05 5.65,115.97 27.09,150.50 L0.00,150.00 L0.00,0.00 Z" ></path>
                </svg>
                <svg class="circle-mask-content-2" viewBox="0 0 500 150" preserveAspectRatio="none" style="height: 100%; width: 100%;">
                    <path class="mask-2" style="stroke: none; fill: red;" d="M68.85,-10.34 C1.70,34.05 5.65,115.97 27.09,150.50 L0.00,150.00 L0.00,0.00 Z" ></path>
                </svg>
            `;
            }
        ...
        new IntersectionObserver((entries, observer) => {
          entries.forEach(entry => {
            if(entry.intersectionRatio > 0) {
              callback(element, entry.intersectionRatio);
              observer.disconnect();
            }
          });
        }).observe(element);
    ...
    function ScrollHandler(){
        onVisible(header, (element, intersectionRatio)=>{
            if(intersectionRatio < 1){
                btnMenuContainer.classList.add("fixed-bottom");
            }
            else {
                btnMenuContainer.classList.remove("fixed-bottom");
            }
        });
    }
